...
public class GenerateQr extends javax.swing.JFrame {
    ...
    /**
     * Creates new form GeneraterQr
     */
    public GenerateQr() {
        initComponents();
        BDUtility.setImage(this, "images/abc1.jpg", 1201, 501);
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1201, 501));
        setMinimumSize(new java.awt.Dimension(1201, 501));
        setUndecorated(true);
        ...
        btnSaveQr.getAccessibleContext().setAccessibleDescription("");
        btnSaveQrAt.getAccessibleContext().setAccessibleDescription("");
    ...
    private void btnSaveQrActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveQrActionPerformed
        try{
            ...
            File defaultFile = new File(directory, email + ".ipg");
            try{
